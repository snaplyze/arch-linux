...
python3 "$repo_root/tests/vm/frame-evidence.py" --self-test
...
def contract(run_text, helper_text=helper):
    for literal in (
    ...
    for literal in (
        ...
        'manifest/ledger sample count', 'verify_current_source', 'file_binding',
